...
'''
KS.
This code generates and saves softmax predictions for probe images.
...
img_dir = '../../../data/constancy_test_sequences_02/'
save_name = 'constancy_predictions_02'
max_scene = 95*7 # for the PixelVAE am only processing up to here due to batch size limitations
test_scene = 0
scene_data = range(0,max_scene) # how many/which of your images you want to use here (CIFAR = 50k train)
train_cutoff = test_scene # index at which to switch from training to validation images
...
np.save(os.path.join(train_dir, 'latent_reps/{}.npy'.format(save_name)), predictions)
